...
type Paragraph = string | React.ReactNode;
...
const sections: TermsSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "This site may contain certain historical information. Historical information, necessarily, is not current and is provided for your reference only. We reserve the right to modify the contents of this site at anytime, but we have no obligation to update any information on our site. You agree that it is your responsibility to monitor changes to our site.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      <>
        ...
        <strong>For more detail, please review our Returns Policy.</strong>
      </>,
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      <>
        In no case shall{" "}
        <strong>OYO PRODUCTS AND SERVICES PRIVATE LIMITED</strong>, our
  ...
  },
  {
    ...
    paragraphs: [
      <>
        ...
        <strong>OYO PRODUCTS AND SERVICES PRIVATE LIMITED</strong> and our
        ...
        including reasonable attorneys&rsquo; fees, made by any third-party due
    ...
    <div className="bg-[#f5f5f5]">
      <section className="relative isolate overflow-hidden">
        <div className="relative h-[270px] sm:h-[320px] lg:h-[390px]">
          <Image
            src="/T&C.png"
            alt="Terms and Conditions hero background"
            fill
            priority
      ...
      <main className="mx-auto max-w-[1820px] px-4 py-8 sm:px-6 sm:py-10 lg:px-[66px] lg:py-14">
        <article className="bg-white px-5 py-9 shadow-[0_1px_2px_rgba(15,23,42,0.05)] sm:px-8 lg:px-11 lg:py-14">
          <section>
            ...
            <h3 className={`mt-8 ${legalSubheadingClass}`}>
              OVERVIEW
            </h3>

            <div className="mt-4 space-y-11">
              {overviewParagraphs.map((paragraph, index) => (
                <ParagraphBlock key={`overview-${index}`}>
                  {paragraph}
                </ParagraphBlock>
              ))}
            </div>
          ...
          <div className="mt-10 space-y-8 lg:mt-12">
            {sections.map((section) => (
              <section key={section.title}>
                <h3 className={legalSectionTitleClass}>
                  {section.title}
                </h3>
                <div className="mt-4 space-y-10">
                  {section.paragraphs.map((paragraph, index) => (
                    <ParagraphBlock key={`${section.title}-${index}`}>
                      {paragraph}
                    </ParagraphBlock>
                  ))}
                </div>
